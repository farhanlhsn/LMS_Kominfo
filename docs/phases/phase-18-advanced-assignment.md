...
Implement group assignment, peer review, resubmission workflow, annotated feedback placeholder, plagiarism checker abstraction, project showcase, portfolio page.
