# Phase 34 - Pop-out and Dual-Monitor Mode

## Goal

Implement pop-out windows for transcript, notes, AI, discussion, code editor, preview; BroadcastChannel sync; workspace popout sessions; persist layout state.
