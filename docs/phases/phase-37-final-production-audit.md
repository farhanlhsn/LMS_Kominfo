...
Run full architecture audit, security audit, accessibility review, performance review, test coverage review, migration/index review, docs cleanup, demo seed refresh.
