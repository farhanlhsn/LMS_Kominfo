...
Implement internal code runner plugin with Monaco editor, code exercises, submissions, isolated runner adapter, test cases, auto grading, output console, workspace panels.
