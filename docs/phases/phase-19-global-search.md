# Phase 19 - Global and Semantic Search

## Goal

Implement Meilisearch/OpenSearch adapter, global search across courses/lessons/materials/discussions/users/certificates, filters, semantic search via vector DB, search analytics.
