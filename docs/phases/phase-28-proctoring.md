# Phase 28 - Proctoring Readiness

## Goal

Implement proctoring provider abstraction, exam focus mode, tab switch log, copy/paste restrictions, suspicious activity log. Webcam/screen monitoring remains provider-based and consent-based.
