# Phase 11 - Learning Path and Gamification

## Goal

Implement learning paths, learning path enrollment, skills, course skills, recommendations, XP transactions, leaderboard snapshots, achievement logic.
