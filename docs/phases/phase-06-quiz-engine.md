# Phase 06 - Quiz Engine and Question Bank

## Goal

Implement question bank, question types, quiz builder, quiz activity integration, attempt, save answers, submit, auto grading, manual grading for essay, quiz result, progress update if passed.
