# Phase 01 - Auth, RBAC, Multi-Tenant

## Goal

Implement email/password auth, refresh token rotation, current user, organization membership, role and permission guards, active organization context, organization switcher, user/profile pages, audit logs for auth and membership changes.
