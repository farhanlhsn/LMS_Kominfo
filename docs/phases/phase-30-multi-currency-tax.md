# Phase 30 - Multi-Currency and Tax

## Goal

Implement currency fields, organization default currency, exchange rate placeholder, tax/VAT settings, invoice fields, provider currency capability validation.
