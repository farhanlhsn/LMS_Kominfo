...
Implement subtitle/caption upload, multi-language captions, transcript sync, transcript search, timestamp notes, bookmarks, AI summarize video transcript, AI quiz from transcript.
