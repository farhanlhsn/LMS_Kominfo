# Phase 07 - Assignment, Certificate, Goals

## Goal

Implement assignment, submission, rubric grading, certificate templates, PDF certificate with QR verification, public verify page, goals, badges, basic XP.
